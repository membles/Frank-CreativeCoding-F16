...
//queries for data from openweathermap.org. displays the temp for new york and visually portrays certain weather types (ie rain, etc). now takes user input for city.
...
var raindrops = [];
var clouds = [];
var input, inputButton, inputValue;
